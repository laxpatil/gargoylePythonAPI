__author__ = "Laxmikant"
__version__ = "Gargoyle_v.01"
...
def getJSONdata(request,userId,apiKey):
    ...
    response = requests.get(request,headers=headers,verify=False) #need to be verified
...
request='https://localhost:8443/GargoyleApi/getZerodayProducts?limit=100'
userId='user'
